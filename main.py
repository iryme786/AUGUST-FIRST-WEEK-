...
photocp = 'https://graph.org/file/e5a63353f26444d2e20ac-55d976397b2ffcf0d0.jpg'
photozip = 'https://graph.org/file/c31ffe4a039c8b4607777-2645b2e8b3b2477b71.jpg'
...
keyboard = InlineKeyboardMarkup(
    [
        [InlineKeyboardButton(text="🛠️ Help", url="https://t.me/nofraction"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/lexm_8")],
    ]
)
...
image_urls = [
    ...
    "https://graph.org/file/6d982ef2d677fcf8fd61c-9126287d948fe409ed.jpg"
...
async def start(bot, m: Message):
    ...
    start_message = await bot.send_photo(
        chat_id=m.chat.id,
        photo="https://graph.org/file/bb448b82172077c9418ee-5f68570df97e75edde.jpg",
        caption=caption
    )
    ...
    if m.chat.id in AUTH_USERS:
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton(text="📞 Contact", url=f"tg://openmessage?user_id={OWNER}"), InlineKeyboardButton(text="🛠️ Repo", url="https://t.me/lexm_8")],
        ])
...
async def back_to_main_menu(client, callback_query):
    ...
    await callback_query.message.edit_media(
      InputMediaPhoto(
        media="https://graph.org/file/6d982ef2d677fcf8fd61c-9126287d948fe409ed.jpg",
        caption=caption
      ),
...
async def cmd(client, callback_query):
    ...
    await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://graph.org/file/2785e334acbe3a33d9238-35d760a7f383073f9a.jpg",
      caption=caption
    ),
    reply_markup=keyboard
    )
...
async def help_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://graph.org/file/0311790696e724424d8fb-db8bd1c1f279f3d92f.jpg",
      caption=caption
    ),
    reply_markup=keyboard
    )
...
async def help_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://graph.org/file/bb448b82172077c9418ee-5f68570df97e75edde.jpg",
      caption=caption
    ),
    reply_markup=keyboard
  )
